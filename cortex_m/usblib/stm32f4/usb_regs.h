...
#define USB_GCCFG_PWRDWN_Pos          16			/* Power down			*/
#define USB_GCCFG_PWRDWN_Msk          (1<<16)
#define USB_GCCFG_VBUSASEN_Pos        18			/* Enable the VBUS sensing “A” device		*/
#define USB_GCCFG_VBUSASEN_Msk        (1<<18)
#define USB_GCCFG_VBUSBSEN_Pos        19			/* Enable the VBUS sensing “B” device		*/
#define USB_GCCFG_VBUSBSEN_Msk        (1<<19)
#define USB_GCCFG_SOFOUTEN_Pos        20			/* SOF output enable		*/
#define USB_GCCFG_SOFOUTEN_Msk        (1<<20)
#define USB_GCCFG_NOVBUSSENS_Pos      21			/* VBUS sensing disable option		*/
#define USB_GCCFG_NOVBUSSENS_Msk      (1<<21)
